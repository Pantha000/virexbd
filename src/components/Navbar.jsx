...
const Navbar = () => {
  return (
    <div className=' bg-slate-800 py-5 px-20 rounded-b-full fixed w-full'>
        <div className='flex justify-between items-center'>
            ...
            <div className='list-none flex '>
                ...
                <li className='mx-4'><Link  className=' py-2 px-6 rounded-lg font-bold text-medium text-white' style={{backgroundImage :"linear-gradient(170deg, #fdcd3b 75%, #ffffff 25%)"}}>Career</Link></li>
            </div>
        </div>
    </div>
  )
